	...
	return (
		<div className='tc grow card-bg br3 pa4 ma3 mb5 dib bw2 shadow-5'>
			<div>
		        ...
		        <h2 className='center' style={{maxWidth: '30rem'}}>We'll offer a Top 2020 trip destination, will you book a flight on the spot?</h2> 
	      	</div>
	      	<img className='grow pointer' alt='Travel' src={logoTravel} width='250px' height='250px' onClick={() => onRouteChange('/travel')}/>
	      	<div>
	      		<p>You sure deserve a spontanious vacation!</p>
	      	</div>
	    </div>
	);
}
